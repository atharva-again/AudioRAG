...
def create_audio_source_provider(config: AudioRAGConfig) -> AudioSourceProvider:  # noqa: ARG001
    """Create an audio source provider.

    Returns LocalSource for processing local audio files.

    Args:
        config: AudioRAG configuration (not used for local source).

    Returns:
        LocalSource instance for local file processing.
    """
