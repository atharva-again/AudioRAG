...
Note: Use "audiorag [command] --help" for more details on a specific command.
    ...
    index_parser = subparsers.add_parser(
        ...
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Note: Always wrap paths with spaces in quotes to prevent shell errors.

Examples:
  audiorag index "./podcast_episode.mp3"
  audiorag index "./audio_folder/" "interview.wav"
  audiorag index "My Music/Song.mp3"
        """,
    )
